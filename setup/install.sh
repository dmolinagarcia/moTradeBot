...
executeStep "Obtaining SSL certificate" "sudo certbot --apache --non-interactive --agree-tos -m ${vEMAIL} --domains ${vSITEURL} --redirect"
...
sudo crontab -u moTrade -l |  { cat; echo "*/10 * * * * curl -k https://${vSITEURL}/process/"; } | sudo crontab -u moTrade -
sudo crontab -u moTrade -l |  { cat; echo "1 1 * * * curl -k https://${vSITEURL}/balance/"; } | sudo crontab -u moTrade -
